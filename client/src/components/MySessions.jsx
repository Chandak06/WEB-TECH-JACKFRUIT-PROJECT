        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <h1 className="text-4xl font-bold mb-2">
              <span className="bg-gradient-to-r from-violet-400 to-purple-400 bg-clip-text text-transparent">My Sessions</span>
            </h1>
            <p className="text-slate-400">Manage your upcoming and past mentorship sessions</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
            <div className="backdrop-blur-xl bg-white/5 rounded-2xl border border-white/10 p-6">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  <p className="text-2xl font-bold text-white">{getTabCount('upcoming')}</p>
            ...
            <div className="backdrop-blur-xl bg-white/5 rounded-2xl border border-white/10 p-6">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  <p className="text-2xl font-bold text-white">{getTabCount('completed')}</p>
            ...
            <div className="backdrop-blur-xl bg-white/5 rounded-2xl border border-white/10 p-6">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  <p className="text-2xl font-bold text-white">{sessions.completed.reduce((acc, s) => acc + s.duration, 0)}</p>
          ...
          {sessions[activeTab].length === 0 && (
            <div className="text-center py-16 backdrop-blur-xl bg-white/5 rounded-2xl border border-white/10">
              ...
              <h3 className="text-2xl font-bold text-white mb-2">No {activeTab} sessions</h3>
              <p className="text-slate-400 mb-6">
                {activeTab === 'upcoming' && 'Book a session to get started with your learning journey'}
                {activeTab === 'completed' && 'Complete sessions will appear here'}
